...
//
    ...
    @Multipart
    @PUT("notice/photo")
    Call<Company> updateNotice(@Part("photo") RequestBody photo, @Part("description") RequestBody description);
    ...
    Call<Company> getNotice(@Path("title") String title);
     ...
     * */
    @GET("notice")
    Call<Company> getNoticeUsingHeader(@Header("Authorization") String authorization);
